...
カジュアルな公式資料としは事業代表者の荒木英士（DJ RIO）によるこちらをご参考にいただけると幸いです@<bib>{Wantedly}。
...
本稿ではVTuber技術、特に次世代型のライブエンターテインメントで使えそうなR&Dの中でも、特に技術的な裏話をしていきたいと思います。
とはいえ扱っている技術は膨大で範囲も広いので、
特に2019年11月に実施した「SIGGRAPH Real-Time Live!」について、技術的なチャレンジといくつかの実装を紹介していきます。
