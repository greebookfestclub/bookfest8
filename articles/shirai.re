...
「直感アルゴリズム」の出演と双方向触覚を実装する、そして今回のデモを成立させる上で、``全部盛り''の状態から戦略的な取捨選択を行いました。
...
さてこの時点での座組は、NTTドコモ、バーチャルキャスト社、ジャストプロ、EXR、Hapbeat、そしてWFLEとGREE VRStudio Labという7社横断のスーパーチームです。
