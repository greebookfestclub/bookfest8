...
さて、システムは完成しました。
国際リモートライブのためのリハーサル、特に日豪同時リハーサルを11月17日に実施し、
やReal-Time Live!特有の公式練習、ひたすらダンスの練習（オリジナル振付）、機材がクソ重い、音声品質と遠のくゴール、不測のトラブル、すごすぎる他の発表者…などなどいろいろありましたが、そろそろ長すぎるような気もするのでこのへんで筆を置きたいと思います。
