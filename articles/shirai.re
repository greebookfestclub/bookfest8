...
の3つを基本方針として活動しています。
株式会社Wright Flyer Live EntertainmentのVTuber専用ライブ配信プラットフォーム「REALITY」開発チームのもつ知見や経験を、日本国内の大学・企業・研究機関などの研究者や学生等とのコミュニケーションを通じて共有し、知財開発およびスピード感のある社会実装、品質向上、技術発信に貢献しています。

//image[WFLEPT-GVRS][WFLE PTとGREE VR Studioの位置づけ]

★研究概要列挙★ YouTube http://j.mp/VRSYT
